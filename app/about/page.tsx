          ...
          <div className="space-y-4 text-center md:text-left">
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-3 pt-2">
              <a
                ...
                className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-xs font-bold hover:bg-slate-200 dark:hover:bg-slate-800 transition-all text-slate-700 dark:text-slate-300"
              >
                <svg className="w-4 h-4 fill-slate-800 dark:fill-white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <a
                href="https://linkedin.com/in/rajaryan2204"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-blue-50 dark:bg-blue-950/20 border border-blue-100 dark:border-blue-900/30 text-xs font-bold hover:bg-blue-100 dark:hover:bg-blue-950/40 transition-all text-blue-600 dark:text-blue-400"
              >
                <svg className="w-3.5 h-3.5 fill-blue-500" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
